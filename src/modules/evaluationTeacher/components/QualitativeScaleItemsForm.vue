<template>
  <form @submit.prevent="save">
    <AppFormModal title="Agregar Escala Cualitativa">
      <template #content>
        <div class="row">
          ...
          <AppFormField :formControl="v$.form.id" :label="'Valor'">
            <input type="number" class="form-control" id="valor" v-model="v$.form.value.$model" />
          </AppFormField>
        </div>
...
export default defineComponent({
  name: 'QualitativeScaleItemsForm',
