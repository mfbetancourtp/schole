<template>
  ...
  <div class="form-row">
    <!-- Grado -->
    <AppFormField v-if="isDegrees" :form-control="v$.form.degreeId"
...
export default defineComponent({
  ...
  props: {
    ...
    isDegrees:      { type: Boolean, default: false },
    permission:      String,
    isLevelMultiple:      { type: Boolean, default: false },
  },
  setup(props) {
    /* Estado */
  ...
  console.log('Cursos deduplicados:', allCourses.value);
    ...
    watch(
      ...
      async periodId => {
        ...
        if (props.v$.form.levelId) props.v$.form.levelId.$model = null;
        if (props.v$.form.degreeId) props.v$.form.degreeId.$model = null;
        if (props.isSubjects && props.v$.form.subjectId) props.v$.form.subjectId.$model = null;
    ...
    watch(
      ...
      async levelId => {
        ...
        if (props.v$.form.degreeId) props.v$.form.degreeId.$model = null;
        if (props.v$.form.subjectId) props.v$.form.subjectId.$model = null;
        ...
        if (props.isSubjects) {
          ...
          coursesByLevel.value     = byLevel;
          subjectAssignments.value = uniqBySubjectId(byLevel);
        }
    ...
    if (props.isSubjects) {
      watch(
        ...
        async degreeId => {
          ...
          subjectAssignments.value = uniqBySubjectId(list);
        }
      );
    }
