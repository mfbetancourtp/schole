...
import { UpdatePositionStudentService } from '../services/reports/updatePositionStudent.service';
import AppButton from '../../../shared/components/Buttons/AppButton.vue';
import AppFormModal from '../../../shared/components/Modal/AppFormModal.vue';
import AppFormField from '../../../shared/components/Forms/AppFormField.vue';

const updatePositionStudentService = new UpdatePositionStudentService();
  ...
  setup(props, { emit }) {
    ...
    const save = async () => {
      ...
      try {
        ...
        await updatePositionStudentService.run(
          dataSend,
          props?.data?.matriculateNotePeriodId
        );
      } catch (e) {
        console.log(e);
      }
