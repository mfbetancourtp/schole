<template>
  ...
  <BaseReport v-else :title="title" :v$="v$" :routes="routes" :service="service" :params="params" :showBtnGenerate="false">
    ...
    <FilterAcademicPeriodWithDegrees :isLevelMultiple="true" :academic-periods="filters.academicPeriods" :v$="v$"></FilterAcademicPeriodWithDegrees>
...
import { GenerateReportFinalPerformanceEvaluationService } from '../services/reports/generateReportFinalPerformanceEvaluation.service';
...
export default defineComponent({
  name: 'FinalPerformanceEvaluation',
  components: {
  ...
  setup() {
    const title = 'reports.finalPerformanceEvaluation';
    ...
    const service = new GenerateReportFinalPerformanceEvaluationService();
