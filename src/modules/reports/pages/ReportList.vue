<template>
  <AppBaseList :title="title">
    <template #content>
          ...
          <div>
            <div class="d-flex justify-content-between">
              ...
              <div class="icons">
                ...
                <AppCheckPermission permission="reports.signatureConfiguration.list">
                  <AppButton class="childs-icons" size="lg" v-tooltip="'Configuración de Firmas'" variant="primary" icon="file-contract" @click="openFormModalConfigurationSignatures(report.id)">
                  </AppButton>
                </AppCheckPermission>
              </div>
            </div>
      ...
      <AppModal v-model="openModal" size="xl">
        <ConfigurationOfSignatures v-if="openModal && currentItemId" :data="modalInformation" :item-id="currentItemId" @close="closeModalForm"> </ConfigurationOfSignatures>
      </AppModal>
    </template>
  </AppBaseList>
</template>
...
import ConfigurationOfSignatures from '../components/ConfigurationOfSignatures.vue';
...
export default defineComponent({
  ...
  components: {
    ...
    AppButton,
    AppModal,
    ConfigurationOfSignatures,
    AppCheckPermission,
  },
  setup() {
    const { t } = useI18n();
    const title = 'reports.name';
    ...
    onMounted(() => {
      ...
      headerStorage.module = { name: 'Reportes', url: '' };
    ...
    const openFormModalConfigurationSignatures = async (itemId: any) => {
      currentItemId.value = itemId;
      console.log('prueba12', currentItemId.value);
    ...
    return {
      ...
      search,
      openModal,
      openFormModalConfigurationSignatures,
      closeModalForm,
      data,
      modalInformation,
      currentItemId,
