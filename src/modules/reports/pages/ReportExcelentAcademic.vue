<template>
  ...
  <BaseReport v-else :title="title" :v$="v$" :routes="routes" :service="service" :params="params">
    ...
    <!-- <FilterShowFields :options="filteredOptions" :v$="v$" :showFieldsCampus="false"></FilterShowFields> -->
    <!-- </div> -->
  </BaseReport>
</template>
...
import { GenerateReportExcelentAcedemicService } from '../services/reports/generateReportExcelentAcademic.service';
...
export default defineComponent({
  ...
  setup() {
    const title = 'report.excelent.academic';
    ...
    const service = new GenerateReportExcelentAcedemicService();
