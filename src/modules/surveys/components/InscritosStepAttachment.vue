<template>
  ...
  <AppDatatable v-else :name="name" :service="service" :params="params">
    ...
    <AppDatatableColumn label="Adjuntos" field="quantity" :sortable="true" v-slot="{ row }">
      {{ row.quantity }}
    </AppDatatableColumn>
    ...
    <AppDatatableColumn v-slot="{ row }">
      <AppButtonGroup>
        ...
        <AppButton
          ...
          @click="approveOrReject(1, row.id, row.rejectedObservations)"
          variant="primary"
          icon="thumbs-up"
          outlined
        ></AppButton>
        ...
        <AppButton
          ...
          @click="approveOrReject(0, row.id, row.rejectedObservations)"
          variant="primary"
          icon="thumbs-down"
          outlined
        ></AppButton>
