...
export class CreateOrUpdatePlayTimesService extends CreateOrUpdateBaseService<any> {
  url = `${services.academic}/academic-planning/academic-period-groups/update-play-times`;
  isFormData = false;
}
